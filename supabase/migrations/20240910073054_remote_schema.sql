...
CREATE TABLE IF NOT EXISTS "public"."order_items" (
    ...
    "size" "text" DEFAULT 'S'::"text" NOT NULL,
...
CREATE POLICY "order_items_policy " ON "public"."order_items" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "order_policy" ON "public"."orders" TO "authenticated" USING (true) WITH CHECK (true);
